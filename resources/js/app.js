...
Vue.component('add-ingredient-component', require('./components/AddIngredientComponent.vue').default);
Vue.component('edit-vendor-component', require('./components/EditVendorComponent.vue').default);
Vue.component('edit-ingredient-component', require('./components/EditIngredientComponent.vue').default);
/**
